            ...
            $.each(this.actions, function (index, action) {
                if (action.divider === true) {
                    ...
                    if (action.name) {
                        ...
                        templateActionsList += '<li role="presentation"><a class="node-action-' + index + '" tabindex="-1">' + name + '</a></li>';
                    } else {
                        templateActionsList += '<li role="presentation"><a class="hide node-action-' + index + '" tabindex="-1">' + '</a></li>';
                    }
                }
            });
