...
!function (a) {
    ...
    j.DEFAULTS = {
    ...
    }, j.LOCALES = [], j.LOCALES["en-US"] = {
        formatLoadingMessage: function () {
            return "Loading, please wait..."
        }, formatRecordsPerPage: function (a) {
            return d("%s records per page", a)
        }, formatShowingRows: function (a, b, c) {
            return d("Showing %s to %s of %s rows", a, b, c)
    ...
    }, a.extend(j.DEFAULTS, j.LOCALES["en-US"]), j.COLUMN_DEFAULTS = {
        radio: !1,
        checkbox: !1,
        checkboxEnabled: !0,
        field: void 0,
        ...
        this.initContainer(), this.initTable(), this.initHeader(), this.initData(), this.initFooter(), this.initToolbar(), this.initPagination(), this.initBody(), this.initServer(), this.initKeyEvents()
        ...
        this.$header = this.$el.find("thead"), this.$header.length || (this.$header = a("<thead></thead>").appendTo(this.$el)), this.$header.find("tr").length || this.$header.append("<tr></tr>"), this.$header.find("th").each(function () {
            var b = a.extend({}, {title: a(this).html(), "class": a(this).attr("class")}, a(this).data());
            c.push(b)
        ...
        }), g ? (this.$header.off("keyup", "input").on("keyup", "input", function (a) {
        ...
        this.$footer = this.$container.find(".fixed-table-footer"), !this.options.showFooter || this.options.cardView ? this.$footer.hide() : this.$footer.show()
        ...
        -1 !== e && this.data.sort(function (f, g) {
            var i = f[c], j = g[c], k = h(b.header, b.header.sorters[e], [i, j]);
        ...
        var c = a(b.currentTarget).parent(), d = this.$header.find("th").eq(c.index());
        ...
        this.$toolbar = this.$container.find(".fixed-table-toolbar").html(""), "string" == typeof this.options.toolbar && a(d('<div class="bars pull-%s"></div>', this.options.toolbarAlign)).appendTo(this.$toolbar).append(a(this.options.toolbar)), f = [d('<div class="columns columns-%s btn-group pull-%s">', this.options.buttonsAlign, this.options.buttonsAlign)], "string" == typeof this.options.icons && (this.options.icons = h(null, this.options.icons)), this.options.showPaginationSwitch && f.push(d('<button class="btn btn-default" type="button" name="paginationSwitch" title="%s">', this.options.formatPaginationSwitch()), d('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.paginationSwitchDown), "</button>"), this.options.showRefresh && f.push(d('<button class="btn btn-default' + (void 0 === this.options.iconSize ? "" : " btn-" + this.options.iconSize) + '" type="button" name="refresh" title="%s">', this.options.formatRefresh()), d('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.refresh), "</button>"), this.options.showToggle && f.push(d('<button class="btn btn-default' + (void 0 === this.options.iconSize ? "" : " btn-" + this.options.iconSize) + '" type="button" name="toggle" title="%s">', this.options.formatToggle()), d('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.toggle), "</button>"), this.options.showColumns && (f.push(d('<div class="keep-open btn-group" title="%s">', this.options.formatColumns()), '<button type="button" class="btn btn-default' + (void 0 == this.options.iconSize ? "" : " btn-" + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">', d('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.columns), ' <span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">'), a.each(this.options.columns, function (a, b) {
            if (!(b.radio || b.checkbox || e.options.cardView && !b.cardVisible)) {
                ...
                b.switchable && (f.push(d('<li><label><input type="checkbox" data-field="%s" value="%s"%s> %s</label></li>', b.field, a, c, b.title)), i++)
            }
        ...
        })), this.options.search && (f = [], f.push('<div class="pull-' + this.options.searchAlign + ' search">', d('<input class="form-control' + (void 0 === this.options.iconSize ? "" : " input-" + this.options.iconSize) + '" type="text" placeholder="%s">', this.options.formatSearch()), "</div>"), this.$toolbar.append(f.join("")), c = this.$toolbar.find(".search input"), c.off("keyup").on("keyup", function (a) {
            clearTimeout(g), g = setTimeout(function () {
                e.onSearch(a)
            }, e.options.searchTimeOut)
        }), "" !== this.options.searchText && (c.val(this.options.searchText), clearTimeout(g), g = setTimeout(function () {
            c.trigger("keyup")
        }, e.options.searchTimeOut)))
    ...
    }, j.prototype.onColumnSearch = function (b) {
        var c = a.trim(a(b.currentTarget).val()), d = a(b.currentTarget).parent().parent().data("field");
        a.isEmptyObject(this.filterColumnsPartial) && (this.filterColumnsPartial = {}), c ? this.filterColumnsPartial[d] = c : delete this.filterColumnsPartial[d], this.options.pageNumber = 1, this.initSearch(), this.updatePagination()
    }, j.prototype.initSearch = function () {
        var b = this;
        if ("server" !== this.options.sidePagination) {
            var c = this.searchText && this.searchText.toLowerCase(), d = a.isEmptyObject(this.filterColumns) ? null : this.filterColumns, e = a.isEmptyObject(this.filterColumnsPartial) ? null : this.filterColumnsPartial;
            this.data = d ? a.grep(this.options.data, function (a) {
                ...
                for (var f in e) {
                    var g = e[f].toLowerCase(), i = c[f];
                    if (i = h(b.header, b.header.formatters[a.inArray(f, b.header.fields)], [i, c, d], i), -1 === a.inArray(f, b.header.fields) || "string" != typeof i && "number" != typeof i || -1 === (i + "").toLowerCase().indexOf(g))return !1
                }
                return !0
            }) : this.data, this.data = c ? a.grep(this.data, function (d, e) {
                for (var f in d) {
        ...
        var b, c, e, f, g, h, i, j, k, l = this, m = [], n = !1, o = this.getData();
        ...
        var q = [d('<span class="btn-group %s">', "top" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? "dropdown" : "dropup"), '<button type="button" class="btn btn-default ' + (void 0 === this.options.iconSize ? "" : " btn-" + this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">', '<span class="page-size">', n ? this.options.formatAllRows() : this.options.pageSize, "</span>", ' <span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">'], r = this.options.pageList;
        ...
        for (a.each(r, function (a, b) {
            if (!l.options.smartDisplay || 0 === a || r[a - 1] <= l.options.totalRows) {
                var c;
                c = n ? b === l.options.formatAllRows() ? ' class="active"' : "" : b === l.options.pageSize ? ' class="active"' : "", q.push(d('<li%s><a href="javascript:void(0)">%s</a></li>', c, b))
            }
        }), q.push("</ul></span>"), m.push(this.options.formatRecordsPerPage(q.join(""))), m.push("</span>"), m.push("</div>", '<div class="pull-' + this.options.paginationHAlign + '">', '<ul class="pagination' + (void 0 === this.options.iconSize ? "" : " pagination-" + this.options.iconSize) + '">', '<li class="page-first"><a href="javascript:void(0)">&lt;&lt;</a></li>', '<li class="page-pre"><a href="javascript:void(0)">&lt;</a></li>'), this.totalPages < 5 ? (c = 1, e = this.totalPages) : (c = this.options.pageNumber - 2, e = c + 4, 1 > c && (c = 1, e = 5), e > this.totalPages && (e = this.totalPages, c = e - 4)), b = c; e >= b; b++)m.push('<li class="page-number' + (b === this.options.pageNumber ? " active" : "") + '">', '<a href="javascript:void(0)">', b, "</a>", "</li>");
        ...
        for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
            ...
            if (p = h(this.options, this.options.rowAttributes, [m, k], p))for (l in p)q.push(d('%s="%s"', l, i(p[l])));
            g.push("<tr", d(" %s", q.join(" ")), d(' id="%s"', a.isArray(m) ? void 0 : m._id), d(' class="%s"', n.classes || (a.isArray(m) ? void 0 : m._class)), d(' data-index="%s"', k), d(' data-unique-id="%s"', m[this.options.uniqueId]), ">"), this.options.cardView && g.push(d('<td colspan="%s">', this.header.fields.length)), a.each(this.header.fields, function (b, i) {
                var j = "", l = m[i], p = "", q = {}, r = "", s = c.header.classes[b], t = "", u = c.options.columns[f(c.options.columns, i)];
                if (n = d('style="%s"', o.concat(c.header.styles[b]).join("; ")), l = h(c.header, c.header.formatters[b], [l, m, k], l), m["_" + i + "_id"] && (r = d(' id="%s"', m["_" + i + "_id"])), m["_" + i + "_class"] && (s = d(' class="%s"', m["_" + i + "_class"])), q = h(c.header, c.header.cellStyles[b], [l, m, k], q), q.classes && (s = d(' class="%s"', q.classes)), q.css) {
                    var v = [];
                    for (var w in q.css)v.push(w + ": " + q.css[w]);
                    n = d('style="%s"', v.concat(c.header.styles[b]).join("; "))
                }
                if (m["_" + i + "_data"] && !a.isEmptyObject(m["_" + i + "_data"]) && a.each(m["_" + i + "_data"], function (a, b) {
                        "index" !== a && (t += d(' data-%s="%s"', a, b))
                    }), u.checkbox || u.radio)p = u.checkbox ? "checkbox" : p, p = u.radio ? "radio" : p, j = [c.options.cardView ? '<div class="card-view">' : '<td class="bs-checkbox">', "<input" + d(' data-index="%s"', k) + d(' name="%s"', c.options.selectItemName) + d(' type="%s"', p) + d(' value="%s"', m[c.options.idField]) + d(' checked="%s"', l === !0 || l && l.checked ? "checked" : void 0) + d(' disabled="%s"', !u.checkboxEnabled || l && l.disabled ? "disabled" : void 0) + " />", c.options.cardView ? "</div>" : "</td>"].join(""); else {
                    if (l = "undefined" == typeof l || null === l ? c.options.undefinedText : l, j = c.options.cardView ? ['<div class="card-view">', c.options.showHeader ? d('<span class="title" %s>%s</span>', n, e(c.options.columns, "field", "title", i)) : "", d('<span class="value">%s</span>', l), "</div>"].join("") : [d("<td%s %s %s %s>", r, s, n, t), l, "</td>"].join(""), void 0 !== u.filterControl && "select" === u.filterControl.toLowerCase() && u.searchable) {
                        var x, y = a("." + u.field), z = 0, A = !1;
                        if (void 0 !== y)if (x = y.get(0).options, 0 === x.length)y.append(a("<option></option>").attr("value", "").text("")), y.append(a("<option></option>").attr("value", l).text(l)); else {
                            for (; z < x.length; z++)if (x[z].value === l) {
                                A = !0;
                                break
                            }
                            A || y.append(a("<option></option>").attr("value", l).text(l))
                        }
                    }
        ...
        g.length || g.push('<tr class="no-records-found">', d('<td colspan="%s">%s</td>', this.header.fields.length, this.options.formatNoMatches()), "</tr>"), this.$body.html(g.join("")), b || this.scrollTo(0), this.$body.find("> tr > td").off("click").on("click", function () {
            var b = a(this).parent();
            c.trigger("click-row", c.data[b.data("index")], b), c.options.clickToSelect && c.header.clickToSelects[b.children().index(a(this))] && b.find(d('[name="%s"]', c.options.selectItemName))[0].click()
        }), this.$body.find("tr").off("dblclick").on("dblclick", function () {
            c.trigger("dbl-click-row", c.data[a(this).data("index")], a(this))
        }), this.$selectItem = this.$body.find(d('[name="%s"]', this.options.selectItemName)), this.$selectItem.off("click").on("click", function (b) {
            b.stopImmediatePropagation();
            var d = a(this).prop("checked"), e = c.data[a(this).data("index")];
            e[c.header.stateField] = d, c.trigger(d ? "check" : "uncheck", e), c.options.singleSelect && (c.$selectItem.not(this).each(function () {
                c.data[a(this).data("index")][c.header.stateField] = !1
            }), c.$selectItem.filter(":checked").not(this).prop("checked", !1)), c.updateSelected()
        }), a.each(this.header.events, function (b, d) {
            if (d) {
                "string" == typeof d && (d = h(null, d));
                for (var e in d)c.$body.find("tr").each(function () {
                    var f = a(this), g = f.find(c.options.cardView ? ".card-view" : "td").eq(b), h = e.indexOf(" "), i = e.substring(0, h), j = e.substring(h + 1), k = d[e];
                    g.find(j).off(i).on(i, function (a) {
                        var d = f.data("index"), e = c.data[d], g = e[c.header.fields[b]];
        ...
        this.options.url && ("limit" === this.options.queryParamsType && (f = {
            ...
            sort: f.sortName,
            order: f.sortOrder
        }, this.options.pagination && (f.limit = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize, f.offset = this.options.pageSize === this.options.formatAllRows() ? 0 : this.options.pageSize * (this.options.pageNumber - 1))), a.isEmptyObject(this.filterColumnsPartial) || (f.filter = JSON.stringify(this.filterColumnsPartial, null)), e = h(this.options, this.options.queryParams, [f], e), a.extend(e, c || {}), e !== !1 && (b || this.$loading.show(), a.ajax(a.extend({}, h(null, this.options.ajaxOptions), {
            ...
            success: function (a) {
                a = h(d.options, d.options.responseHandler, [a], a), d.load(a), d.trigger("load-success", a)
            },
            error: function (a) {
        ...
        if (this.options.keyEvents) {
            var b = this;
            a(document).off("keypress").on("keypress", function (a) {
                var c = b.$toolbar.find(".search input"), d = b.$toolbar.find('button[name="refresh"]'), e = b.$toolbar.find('button[name="toggle"]'), f = b.$toolbar.find('button[name="paginationSwitch"]');
                switch (a.keyCode) {
                    case 115:
                    case 83:
                    ...
                    case 82:
                        ...
                        return document.activeElement === c.get(0) ? !0 : (d.click(), !1);
                    case 116:
                    case 84:
                        if (!b.options.showToggle)return;
                        return document.activeElement === c.get(0) ? !0 : (e.click(), !1);
                    case 112:
                    case 80:
                        if (!b.options.showPaginationSwitch)return;
                        return document.activeElement === c.get(0) ? !0 : (f.click(), !1)
                }
            })
        }
        ...
        b += ".bs.table", this.options[j.EVENTS[b]].apply(this.options, c), this.$el.trigger(a.Event(b), c), this.options.onAll(b, c), this.$el.trigger(a.Event("all.bs.table"), [b, c])
    }, j.prototype.resetHeader = function () {
        this.$el.css("margin-top", -this.$header.height()), clearTimeout(this.timeoutId_), this.timeoutId_ = setTimeout(a.proxy(this.fitHeader, this), this.$el.is(":hidden") ? 100 : 0)
    }, j.prototype.fitHeader = function () {
        var b, c, d, e = this;
        return e.$el.is(":hidden") ? void(e.timeoutFooter_ = setTimeout(a.proxy(e.fitHeader, e), 100)) : (b = e.$container.find(".fixed-table-header"), c = e.$container.find(".fixed-table-body"), d = e.$el.width() > c.width() ? g() : 0, e.$header_ = e.$header.clone(!0, !0), e.$selectAll_ = e.$header_.find('[name="btSelectAll"]'), b.css({"margin-right": d}).find("table").css("width", e.$el.css("width")).html("").attr("class", e.$el.attr("class")).append(e.$header_), e.$header.find("th").each(function (b) {
        ...
        }), c.off("scroll").on("scroll", function () {
            b.scrollLeft(a(this).scrollLeft())
        }), void e.trigger("post-header"))
    }, j.prototype.resetFooter = function () {
        var b = this, c = b.getData(), e = [];
        this.options.showFooter && !this.options.cardView && (a.each(this.options.columns, function (a, f) {
            var g = "", i = "", j = d(' class="%s"', f["class"]);
            f.visible && (!b.options.cardView || f.cardVisible) && (g = d("text-align: %s; ", f.falign ? f.falign : f.align), i = d("vertical-align: %s; ", f.valign), e.push("<td", j, d(' style="%s"', g + i), ">"), e.push(h(f, f.footerFormatter, [c], "&nbsp;") || "&nbsp;"), e.push("</td>"))
        }), this.$footer.find("tr").html(e.join("")), clearTimeout(this.timeoutFooter_), this.timeoutFooter_ = setTimeout(a.proxy(this.fitFooter, this), this.$el.is(":hidden") ? 100 : 0))
    }, j.prototype.fitFooter = function () {
        var b, c, d, e;
        return clearTimeout(this.timeoutFooter_), this.$el.is(":hidden") ? void(this.timeoutFooter_ = setTimeout(a.proxy(this.fitFooter, this), 100)) : (b = this.$container.find(".fixed-table-body"), d = this.$el.css("width"), e = d > b.width() ? g() : 0, this.$footer.css({"margin-right": e}).find("table").css("width", d).attr("class", this.$el.attr("class")), c = this.$footer.find("td"), void b.find("tbody tr:first-child:not(.no-records-found) > td").each(function (b) {
            c.eq(b).outerWidth(a(this).outerWidth())
        }))
    }, j.prototype.toggleColumn = function (a, b, c) {
        if (-1 !== a && (this.options.columns[a].visible = b, this.initHeader(), this.initSearch(), this.initPagination(), this.initBody(), this.options.showColumns)) {
            ...
            c && e.filter(d('[value="%s"]', a)).prop("checked", b), e.filter(":checked").length <= this.options.minimumCountColumns && e.filter(":checked").prop("disabled", !0)
        }
    }, j.prototype.toggleRow = function (b, c, e) {
        -1 !== b && a(this.$body[0]).children().filter(d(c ? '[value="%s"]' : '[data-index="%s"]', b))[e ? "show" : "hide"]()
    }, j.prototype.resetView = function (a) {
        var c = this, d = 0, e = c.$container.find(".fixed-table-container");
        if (a && a.height && (this.options.height = a.height), this.$selectAll.prop("checked", this.$selectItem.length > 0 && this.$selectItem.length === this.$selectItem.filter(":checked").length), this.options.height) {
            var f = +this.$toolbar.children().outerHeight(!0), g = +this.$pagination.children().outerHeight(!0), h = this.options.height - f - g;
            e.css("height", h + "px")
        }
        ...
        return !this.searchText && a.isEmptyObject(this.filterColumns) && a.isEmptyObject(this.filterColumnsPartial) ? this.options.data : this.data
    ...
    }, j.prototype.getRowsHidden = function (b) {
        ...
        this.$selectItem.filter(d('[data-index="%s"]', b)).prop("checked", a), this.data[b][this.header.stateField] = a, this.updateSelected(), this.trigger(a ? "check" : "uncheck", this.data[b])
    }, j.prototype.checkBy = function (a) {
        this.checkBy_(!0, a)
    }, j.prototype.uncheckBy = function (a) {
        this.checkBy_(!1, a)
    }, j.prototype.checkBy_ = function (b, c) {
        if (c.hasOwnProperty("field") && c.hasOwnProperty("values")) {
            var e = this;
            a.each(this.options.data, function (f, g) {
                return g.hasOwnProperty(c.field) ? void(-1 !== a.inArray(g[c.field], c.values) && (e.$selectItem.filter(d('[data-index="%s"]', f)).prop("checked", b), g[e.header.stateField] = b, e.trigger(b ? "check" : "uncheck", g))) : !1
            }), this.updateSelected()
        }
        ...
        this.toggleColumn(f(this.options.columns, a), !0, !0)
    }, j.prototype.hideColumn = function (a) {
        this.toggleColumn(f(this.options.columns, a), !1, !0)
    ...
    var k = ["getOptions", "getSelections", "getData", "load", "append", "prepend", "remove", "insertRow", "updateRow", "showRow", "hideRow", "getRowsHidden", "mergeCells", "checkAll", "uncheckAll", "check", "uncheck", "checkBy", "uncheckBy", "refresh", "resetView", "destroy", "showLoading", "hideLoading", "showColumn", "hideColumn", "filterBy", "scrollTo", "selectPage", "prevPage", "nextPage", "togglePagination", "toggleView"];
    a.fn.bootstrapTable = function (b, c) {
        var d;
        return this.each(function () {
            var e = a(this), f = e.data("bootstrap.table"), g = a.extend({}, j.DEFAULTS, e.data(), "object" == typeof b && b);
            if ("string" == typeof b) {
    ...
    }, a.fn.bootstrapTable.Constructor = j, a.fn.bootstrapTable.defaults = j.DEFAULTS, a.fn.bootstrapTable.columnDefaults = j.COLUMN_DEFAULTS, a.fn.bootstrapTable.locales = j.LOCALES, a.fn.bootstrapTable.methods = k, a(function () {
